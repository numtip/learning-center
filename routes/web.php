...
Route::get('/history/theory', [HistoryController::class, 'theory']);
Route::get('/history/lanna', [HistoryController::class, 'lanna']);
Route::get('/history/huayjo', [HistoryController::class, 'huayjo']);
...
Route::middleware(['auth','role:superadmin'])
    ...
    // --- ส่วนจัดการออเดอร์สลิป ---
    Route::get('/order-slips', [OrderSlipController::class, 'index'])->name('order-slips.index');
    Route::post('/orders/{id}/update-slip', [OrderSlipController::class, 'updateSlip'])->name('orders.updateSlip');
