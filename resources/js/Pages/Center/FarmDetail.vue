...
<template>
  <PublicLayout>
    <Head title="ฟาร์มสาธิตสำนักวิจัยฯ" />
    <div class="minimal-gallery" :class="{ 'is-ready': loaded }">
      <section class="hero-split">
        <div class="hero-text-side">
          ...
          <h1 class="hero-title animate-up-delay-1">
            ฟาร์มสาธิต<br/>
            <span class="serif-italic">สำนักวิจัยฯ</span>
          </h1>
          <p class="hero-para animate-up-delay-2">
            แหล่งถ่ายทอดองค์ความรู้และนวัตกรรมเกษตรต้นแบบ <br/>
            ผ่านพื้นที่สาธิตจริงเพื่อยกระดับผลผลิตและวิถีเกษตรอย่างสร้างสรรค์
          </p>
      ...
      <section class="chrono-v2">
        <div class="container-v2">
          <div class="section-intro">
            <h2 class="light-title">จารึกแห่งการเรียนรู้</h2>
            <p class="sub-intro">บันทึกเรื่องราวและความเป็นมาของฟาร์มสาธิตสำนักวิจัยฯ</p>
          </div>
              ...
              <Transition name="fade-slide" mode="out-in">
                <div :key="activeIndex" class="mega-display-card">
                  ...
                  <div class="display-info">
                    ...
                    <span class="history-label">ความภาคภูมิใจในงานวิจัย</span>
      ...
      <section class="narrative-v3">
        <div class="narrative-container">
          <div class="quote-side">
             ...
             <p class="quote-text">พื้นที่เรียนรู้จริง คือห้องเรียนที่ดีที่สุดของการทำเกษตร</p>
             <span class="quote-author">— ฟาร์มสาธิต</span>
          </div>
      ...
      <section class="gallery-v3">
        <div class="gallery-header">
           <span class="gallery-label">ภาพบรรยากาศฟาร์มสาธิต</span>
        ...
        <div class="gallery-wrapper-v3">
          <div class="gallery-item-v3" v-for="(img, i) in [detail.image1, detail.image2, detail.image3, detail.image1]" :key="i" :class="'item-'+i">
            <img :src="img" />
            <div class="img-overlay"><span>มุมมองฟาร์มสาธิต</span></div>
          </div>
        </div>
      </section>
    </div>
