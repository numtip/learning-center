...
<template>
  <PublicLayout>
    <Head title="ศูนย์ทดสอบ วิจัยและพัฒนากัญชง" />
    <div class="minimal-gallery" :class="{ 'is-ready': loaded }">
      <section class="hero-split">
        <div class="hero-text-side">
          ...
          <h1 class="hero-title animate-up-delay-1">
            ศูนย์ทดสอบ<br/>
            <span class="serif-italic">วิจัยและพัฒนากัญชง</span>
          </h1>
          <p class="hero-para animate-up-delay-2">
            ก้าวล้ำด้วยนวัตกรรมการวิจัยและพัฒนาสายพันธุ์กัญชง <br/>
            มุ่งเน้นมาตรฐานระดับสากลเพื่อการใช้ประโยชน์อย่างยั่งยืน
          </p>
          <div class="hero-action animate-up-delay-3">
            <div class="line-btn">
              <span class="line"></span>
              สำรวจศูนย์วิจัยกัญชง
            </div>
          </div>
        </div>
      ...
      <section class="chrono-v2">
        <div class="container-v2">
          <div class="section-intro">
            <h2 class="light-title">นวัตกรรมการวิจัย</h2>
            <p class="sub-intro">บันทึกเรื่องราวและความเป็นมาของศูนย์ทดสอบ วิจัยและพัฒนากัญชง</p>
          </div>
              ...
              <Transition name="fade-slide" mode="out-in">
                <div :key="activeIndex" class="mega-display-card">
                  ...
                  <div class="display-info">
                    ...
                    <span class="history-label">ความสำเร็จแห่งนวัตกรรม</span>
                    <h3>{{ historyData[activeIndex]?.title }}</h3>
                    <p>{{ historyData[activeIndex]?.description }}</p>
                  </div>
                </div>
              </Transition>
            </div>
      ...
      <section class="narrative-v3">
        <div class="narrative-container">
          <div class="quote-side">
             ...
             <p class="quote-text">วิทยาศาสตร์และนวัตกรรม คือกุญแจสู่การพัฒนาอุตสาหกรรมกัญชง</p>
             <span class="quote-author">— ศูนย์วิจัยกัญชง</span>
          </div>
          <div class="content-side">
            <h2 class="narrative-h2">ความเป็นมา</h2>
            <p class="narrative-p">{{ detail.history }}</p>
          </div>
        </div>
      </section>
      ...
      <section class="gallery-v3">
        <div class="gallery-header">
           <span class="gallery-label">ภาพงานวิจัยและพัฒนา</span>
        ...
        <div class="gallery-wrapper-v3">
          <div class="gallery-item-v3" v-for="(img, i) in [detail.image1, detail.image2, detail.image3, detail.image1]" :key="i" :class="'item-'+i">
            <img :src="img" />
            <div class="img-overlay"><span>มุมมองวิจัยกัญชง</span></div>
          </div>
        </div>
      </section>
    </div>
