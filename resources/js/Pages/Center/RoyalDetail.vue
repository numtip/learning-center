    ...
    <div class="minimal-gallery" :class="{ 'is-ready': loaded }">
      <section class="hero-split">
        <div class="hero-text-side">
          ...
          <h1 class="hero-title animate-up-delay-1">
            ศูนย์การเรียนรู้<br/>
            <span class="serif-italic">เกษตรทฤษฎีใหม่</span>
          </h1>
          <p class="hero-para animate-up-delay-2">
            สัมผัสจิตวิญญาณแห่งผืนดินและการเรียนรู้ที่ไม่สิ้นสุด ผ่านสถาปัตยกรรมแห่งธรรมชาติและความทรงจำที่งดงาม
          </p>
      ...
      <section class="chrono-v2">
        <div class="container-v2">
          <div class="section-intro">
            <h2 class="light-title">เส้นทางแห่งการเติบโต</h2>
            <p class="sub-intro">บันทึกเรื่องราวและความเป็นมาของศูนย์การเรียนรู้เกษตรทฤษฎีใหม่</p>
          </div>
              ...
              <Transition name="fade-slide" mode="out-in">
                <div :key="activeIndex" class="mega-display-card">
                  ...
                  <div class="display-info">
                    ...
                    <span class="history-label">เหตุการณ์สำคัญ</span>
      ...
      <section class="narrative-v3">
        <div class="narrative-container">
          <div class="quote-side">
             ...
             <p class="quote-text">รากฐานของการเรียนรู้ คือหัวใจของการพัฒนาที่ยั่งยืน</p>
             <span class="quote-author">— ศูนย์การเรียนรู้</span>
          </div>
      ...
      <section class="gallery-v3">
        <div class="gallery-header">
            <span class="gallery-label">ภาพกิจกรรมและการเรียนรู้</span>
        ...
        <div class="gallery-wrapper-v3">
          <div class="gallery-item-v3" v-for="(img, i) in [detail.image1, detail.image2, detail.image3, detail.image1]" :key="i" :class="'item-'+i">
            <img :src="img" />
            <div class="img-overlay"><span>มุมมองเกษตรทฤษฎีใหม่</span></div>
          </div>
        </div>
      </section>
    </div>
...
.wrap-text { word-wrap: break-word; overflow-wrap: break-word; white-space: normal; display: block; line-height: 1.8; }
...
/* ปรับ Hero Title เพื่อไม่ให้สระโดนตัด */
.hero-title {
...
.serif-italic {
  font-family: 'Anuphan', sans-serif; /* ใช้ Anuphan เพื่อความเป๊ะของสระไทย */
  font-style: italic;
  font-weight: 600;
  color: #c9a23f;
  background: linear-gradient(90deg, #c9a23f, #e2c074);
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;
  padding-right: 10px; /* กันตัวสุดท้ายโดนตัด */
...
.light-title { font-size: 4rem; color: #1a3a3a; margin-bottom: 10px; line-height: 1.2; }
...
.display-info h3 { font-size: 2.5rem; margin: 20px 0; color: #1a3a3a; position: relative; z-index: 1; line-height: 1.4; }
...
.quote-text { font-size: 2.4rem; font-weight: 300; line-height: 1.6; margin-bottom: 25px; color: #1a3a3a; }
.quote-author { letter-spacing: 4px; font-size: 0.9rem; color: #c9a23f; font-weight: 700; }
.narrative-h2 { font-size: 3.5rem; margin-bottom: 35px; color: #1a3a3a; line-height: 1.3; }
...
.obj-header-cell h2 { font-size: 2.5rem; font-weight: 400; line-height: 1.4; margin-bottom: 20px; }
...
.obj-index { font-weight: 800; color: #c9a23f; font-size: 1.5rem; }
...
@media (max-width: 1024px) {
  ...
  .hero-action { display: center; justify-content: center; }
