...
<template>
  <PublicLayout>
    <Head title="ศูนย์เรียนรู้พัฒนาบ้านโปง" />
    <div class="minimal-gallery" :class="{ 'is-ready': loaded }">
      <section class="hero-split">
        <div class="hero-text-side">
          ...
          <h1 class="hero-title animate-up-delay-1">
            ศูนย์เรียนรู้<br/>
            <span class="serif-italic">พัฒนาบ้านโปง</span>
          </h1>
          <p class="hero-para animate-up-delay-2">
            ขับเคลื่อนการพัฒนาชุมชนผ่านเกษตรกรรมผสมผสาน <br/>
            สร้างรากฐานความเข้มแข็งและวิถีชีวิตที่เป็นสุข ณ บ้านโปง
          </p>
          <div class="hero-action animate-up-delay-3">
            <div class="line-btn">
              <span class="line"></span>
              สำรวจศูนย์เรียนรู้บ้านโปง
            </div>
          </div>
        </div>
      ...
      <section class="chrono-v2">
        <div class="container-v2">
          <div class="section-intro">
            <h2 class="light-title">จารึกการพัฒนา</h2>
            <p class="sub-intro">บันทึกเรื่องราวและความเป็นมาของศูนย์เรียนรู้พัฒนาบ้านโปง</p>
          </div>
              ...
              <Transition name="fade-slide" mode="out-in">
                <div :key="activeIndex" class="mega-display-card">
                  ...
                  <div class="display-info">
                    ...
                    <span class="history-label">ก้าวแห่งความก้าวหน้า</span>
      ...
      <section class="narrative-v3">
        <div class="narrative-container">
          <div class="quote-side">
             ...
             <p class="quote-text">ความเข้มแข็งของชุมชน คือรากฐานของการพัฒนาที่แท้จริง</p>
             <span class="quote-author">— ศูนย์เรียนรู้บ้านโปง</span>
          </div>
      ...
      <section class="gallery-v3">
        <div class="gallery-header">
           <span class="gallery-label">ภาพสะท้อนวิถีชุมชน</span>
        ...
        <div class="gallery-wrapper-v3">
          <div class="gallery-item-v3" v-for="(img, i) in [detail.image1, detail.image2, detail.image3, detail.image1]" :key="i" :class="'item-'+i">
            <img :src="img" />
            <div class="img-overlay"><span>มุมมองพัฒนาบ้านโปง</span></div>
          </div>
        </div>
      </section>
    </div>
