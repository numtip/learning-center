...
class PrController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('SuperAdmin/PrManager', [
            'news' => $news
        ]);
    }
    ...
    {
        DB::table('mju_pr_news')->insert([
            'title' => $request->title,
            'description' => $request->description,
            'event_date' => $request->event_date,   // ⭐ เพิ่ม
    ...
    public function update(Request $request, $id)
    {
        ...
        DB::table('mju_pr_news')->where('id', $id)->update($data);
        return back();
    }

    public function destroy($id)
    {
        DB::table('mju_pr_news')->where('id', $id)->delete();
        return back();
    }
}
